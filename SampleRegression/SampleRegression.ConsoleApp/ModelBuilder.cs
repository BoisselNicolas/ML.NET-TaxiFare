...
namespace SampleRegression.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/home/nicolas/Dev/ML/TaxiFare/taxi-fare.txt";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options() { NumberOfLeaves = 126, MinimumExampleCountPerLeaf = 10, NumberOfTrees = 500, LearningRate = 0.082566485f, Shrinkage = 0.13644025f, LabelColumnName = "fare_amount", FeatureColumnName = "Features" });
